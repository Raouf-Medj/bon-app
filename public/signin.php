...
<body>
    <div class="container">
        <div class="left_col_signin">
            <div class="img1">
                <div class="logo_signin"></div>
            </div>
        </div>
        <div class="right_col_signin">
            <div class="bg1">
                <img
                    ...
                    class="img_auth"
                />
                <h2 class="greeting">Connectez-vous</h2>
                <div style="width: 100%;">
                ...
                <div class='button_container'>
                    <button id="signinButton" type="submit">Se connecter</button>
                </div>
                <div class='text_under_button'>
                    <h3 class='question'>Vous n'avez pas de compte?</h3>
                    <a href="/public/signup.html" class='link'>Inscrivez-vous</a>
                </div>
            </div>
        </div>
    </div>
