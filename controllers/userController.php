<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET' && (isset($_GET['action']))) {
            ...
            if (isset($_POST['username'])) {
                ...
                if ($found !== null) {
                    if (isset($_POST['password'])) {
                        ...
                        else { http_response_code(401); echo '{"error" : "Wrong password"}'; }
                    }
                    else { http_response_code(400); echo '{"error" : "Missing password"}'; }
                }
                else { http_response_code(404); echo '{"error" : "User not found"}'; }
            } 
            else { http_response_code(400); echo '{"error" : "Missing username"}'; }
        }
        ...
        http_response_code(400); echo '{"error" : "invalid request method, use GET or POST only, and specify an \'action\' (in the params for GET) or (in the request body for POST)"}';
    }
?>